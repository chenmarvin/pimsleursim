...
// The gojuon chart (46), plus dakuten (voiced, 20) and handakuten
// (semi-voiced, 5) variants — the standard beginner hiragana/katakana set
// a learner needs before kanji becomes readable at all.
export const ALL_KANA: KanaChar[] = [
